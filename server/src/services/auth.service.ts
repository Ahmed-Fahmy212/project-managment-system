...
//-------------------------------------------------------------------------------------------------------------------
async function validateUser(loginBody: zod.infer<typeof LoginBodySchema>): Promise<User> {
...
//-------------------------------------------------------------------------------------------------------------------
// Register a new user
async function registerUser(registerBodyDto: zod.infer<typeof RegisterBodySchema>): Promise<User> {
...
async function handleTokenGeneration(user: User) {
...
//-------------------------------------------------------------------------------------------------------------------
async function updateRefreshToken(user: Partial<User>, refreshToken: string) {
...
//-------------------------------------------------------------------------------------------------------------------
async function signJwtAccessToken(user: Partial<User>): Promise<string> {
...
//-------------------------------------------------------------------------------------------------------------------
async function signJwtRefreshToken(user: Partial<User>): Promise<string> {
...
//-------------------------------------------------------------------------------------------------------------------
async function refreshToken(response: Response, user: Partial<User>) {
...
//-------------------------------------------------------------------------------------------------------------------
async function generateEmailVerification(email: string): Promise<any> {
    const emailToken = (Math.floor(Math.random() * (900000)) + 100000).toString();
    const createEmailVerificationPayload: ICreateEmailVerification = {
        email,
        emailToken,
...
//-------------------------------------------------------------------------------------------------------------------
async function resetPassword(resetPasswordDto: zod.infer<typeof ResetPasswordSchema>): Promise<string> {
...
//-------------------------------------------------------------------------------------------------------------------
async function verifyEmail(email: string, token: string): Promise<Partial<User>> {
